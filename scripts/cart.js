...
function renderCart() {
    ...
    for (let i = 0; i < cart.length; i++) {
		...
		let colors;
		switch(item.id){
			case 1: colors = ["Pink", "Blue", "Green", "Gray"];
					break;
			case 3: colors = ["Yellow", "Blue", "Green", "Gray"];
				    break;
			case 4: colors = ["One Color"];
			case 5: colors = ["One Color"];
					break;
			default: colors = ["White", "Blue", "Green", "Gray"];
		}	
		...
		let sizes;
		switch(item.id){
			case 4: sizes = ["One Size"];
					break;
			case 5: sizes = ["One Size"];
					break;
